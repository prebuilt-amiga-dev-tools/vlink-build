...
# ./linux/scripts/create-global-environment-variables-script.sh build_results refs/heads/feature-branch prebuilt-amiga-dev-tools/vlink-build false
# ./linux/scripts/create-global-environment-variables-script.sh build_results refs/tags/releases/0.16a prebuilt-amiga-dev-tools/vlink-build true
